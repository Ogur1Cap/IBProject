            ...
            <el-row>
              <el-col :span="16">
                ...
                <div class="line_center_map">
                  <dv-border-box-10>
                  <el-amap :zoom="13"  :features="['bg','road','building']" 	:viewMode="'3D'" :pitch="60"  :rotation="11.4" :center="[115.942465,28.543781]" id="map">
                          <el-amap-marker :position="[121.485041, 31.221364]"></el-amap-marker>
                    </el-amap>
