<template>
    ...
    <el-col :span="18" style="padding-right: 10px;">
      <el-card style="height: 300px">
        ...
        <el-carousel-item v-for="(item, index) in imageList" :key="index">
            <img :src="item.urle" :alt="item.alt" class="carousel-item-container"> 
        </el-carousel-item>
      </el-carousel>
      </el-card>
      ...
      <el-card style="width:100%; height: 533px;">
        <div style="width:100%; height: 500px;">
          <el-button @click="openForm" style="position: relative; top: -1px; right: -455px;" type="primary">添加日志</el-button>
          <el-timeline>
          <el-scrollbar style="height: 400px;">
            <el-timeline-item v-for="(log, index) in logs" :key="index" :timestamp="log.createTime">
              {{ log.content }}
              <br>
              <el-button type="text" @click="deleteLog(index)">删除</el-button>
              <el-button type="text" @click="editLog(index)">编辑</el-button>
            </el-timeline-item>
          </el-scrollbar>
        </el-timeline>
        <el-dialog
        ...
        >
          ...
          <el-form-item label="发布时间">
                  <el-form-item prop="createTime">
                    <el-date-picker   v-model="Rizhi.createTime"  type="date"  placeholder="选择日期" value-format="yyyy-MM-dd">
                    </el-date-picker>
                  </el-form-item>
                </el-form-item>
      ...
      <el-card style="width:100%; height: 533px;">
        <div style="width:100%; height: 500px;">
          <div>
            <el-button @click="showDrawer" style="position: relative; right: -450px;" type="success" v-show="RenwuVisible">添加任务</el-button>
            <el-drawer :visible="drawerVisible" @close="closeDrawer">
              <!-- 在这里放置任务指派的表单 -->
              <div>
              <el-form ref="taskFormData" :model="taskFormData" label-width="120px">
                <el-form-item label="任务内容">
                  <el-input v-model="taskFormData.content"></el-input>
                </el-form-item>
                <el-form-item label="指派人员">
                  <el-select v-model="taskFormData.worker" placeholder="请选择指派人员">
                    <el-option v-for="person in assigneeList" :key="person.id" :label="person.name" :value="person.name"></el-option>
                  </el-select>
                </el-form-item>
                <el-form-item label="发派时间">
                  <el-form-item prop="createTime">
                    <el-date-picker   v-model="taskFormData.createTime"  type="date"  placeholder="选择日期" value-format="yyyy-MM-dd">
                    </el-date-picker>
                  </el-form-item>
                </el-form-item>
              </el-form>
              <el-button @click="addTask" style="position: relative; right: -250px; top: 100px;" type="primary" round>确定保存</el-button>
            </div>
            </el-drawer>
            </div>
            <div>
              ...
              <el-table :data="taskList" v-if="RenwuVisible">
                ...
                <el-table-column prop="worker" label="指派人员"></el-table-column>
                <el-table-column prop="createTime" label="发派时间"></el-table-column>
                <el-table-column label="操作">
                  <template slot-scope="scope">
                    <el-button type="text" @click="editTask(scope.row)">修改</el-button>
  ...
  import {getRizhi, createRizhi,deleteRizhi, updateRizhi,
          getRenwu, createRenwu,deleteRenwu, updateRenwu
  } from '../api/index'
...
export default {
  ...
  methods:{
   ...
   closeDialog() {
    ...
    gettime(){
      var now = new Date();
      this.taskFormData.createTime = now.getFullYear() + '-' + (now.getMonth() + 1) + '-' + now.getDate();
    },
    //----------------------------------
    addLog() {
          // 提交数据
